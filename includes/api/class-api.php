 ...
 * @subpackage Patterns_Construction/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Construction_Api' ) ) {

	/**
	 * Patterns_Construction_Api
	 *
	 * @package Patterns_Construction
	 * @since 1.0.1
	 */
	class Patterns_Construction_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-construction' ), '1.0.0' );
		}
